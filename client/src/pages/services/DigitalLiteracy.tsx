        ...
        impactStories={[
          {
            ...
            description: "Our targeted digital literacy program for older adults in assisted living facilities has helped reduce isolation and improve quality of life through technology access.",
          ...
          },
          {
            ...
            description: "Working with isolated rural communities, we've implemented digital skills programs alongside connectivity solutions to bridge the urban-rural digital divide.",
